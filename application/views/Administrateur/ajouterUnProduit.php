...
?>
    ...
    <label for="txtTVAProduit">Taux TVA du produit</label>
    ...
    <label for="tbxMarqueProduit">Marque du produit</label>
        <select name="tbxMarqueProduit" value="<?php echo set_value('tbxMarqueProduit'); ?>" ></select><br/>

    <label for="tbxCategorieProduit">Catégorie du produit</label>
        <select name="tbxCategorieProduit" value="<?php echo set_value('tbxCategorieProduit'); ?>" ></select><br/>
